...
# Conclusão: Podemos concluir que tupla são definidas pela vírgula e não pelo uso do parênteses
...
tupla = (1, 2, 3, 4, 5, 6, 'b')
# print(sum(tupla))     #Erro
# print(max(tupla))     #Erro
# print(min(tupla))     #Erro
# print(len(tupla))
...
tupla1 = tupla1 + tupla2    #Tuplas são imutáveis, mas podeos sobreescrever seus valores
print(tupla1)

# Verificar se determinado elemento está presente na tupla
...
print(nova)
print(tupla)
# NÃO TEMOS PROBLEMAS COM SHALLOW COPY!!
"""