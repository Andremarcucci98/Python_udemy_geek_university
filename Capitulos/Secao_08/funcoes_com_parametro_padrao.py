...
# Exemplo de função onde a passagem de prametros seja opcional
...
#Obs.: Se o usuário passar somente 1 parâmetro, este será atribuído ao parâmetro numero, e será calculado o quadrado deste numero;
Se o usuario passar 2 argumentos, o primeiro sera atribuido ao paramentro numero e o segundo ao parametro potencia.Entao
será calculada esta potencia.

print(exponencial())

# Obs.: Em funçõe Python, os parâmetros com valores default (padrão) DEVEM sempre estar ao final da declaração.
...
# Quais tipos de dados podemos utilizar como valores dafault para parâmetros?

- Qualquer tipo de dado:
    - Numeros, strings, floats, booleanos, listas, tuplas, dicionaros, funções, etc;
...
def diz_oi():
    instutor = 'Python'         #Variável local
    return f'oi {instrutos}'
...
print(dentro())     # NameError - dentro não é reconhecido, pois está dentro da função fora.
