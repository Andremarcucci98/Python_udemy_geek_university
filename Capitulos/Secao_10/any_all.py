...
print(all((1, 2, 3)))      # Todos os números são verdadeiros? True
print(all({1, 2, 3}))      # Todos os números são verdadeiros? True
...
# Obs.: Um iterável convertido em boolean é False, mas o all() entende como True
...
print(all([num for num in [4, 2, 10, 6, 8, 9] if num % 2 == 0]))             # True
