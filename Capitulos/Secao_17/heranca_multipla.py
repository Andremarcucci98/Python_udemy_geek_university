...
Herança Multipla nada mais é do que a possibilidade de uma classe herdar de multiplas classes, fazendo
com que a classe filha herde todos os atributos e métodos de todas as classes herdadas.

# Obs: A heraça multipla pode ser feita de duas maneiras:
...
# Obs.: Não importa de a derivação é direta ou indireta. A classe que realiza a herança herdará todos
