...
# Obs.: A utlização do print() para debugar código é uma pratica ruim
def dividir(a, b):
    print(f'a={a}, b={b}')
    try:
        return int(a) / int(b)
...
# no início do arquivo. Por isso, ao invés de colocarmos o import do pdb no inicio do arquivo.
