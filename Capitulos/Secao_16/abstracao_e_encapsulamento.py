...
O grande objetivo da programação orientada a objeto é encapsular nosso código dentro de um grupo logico e
...
da classe. Com Python acontece um fenômeno chamado Name Mangling,
